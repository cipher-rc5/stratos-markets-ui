    ...
    steps: [
      {
        ...
        description:
          "Understand Stratos architecture, key components, and how institutional-grade tools democratize access.",
      },
      {
        icon: Code,
        title: "Create Your Account",
        description:
          "Set up your wallet integration, configure authentication, and connect to your preferred blockchain networks.",
      },
      {
        icon: Zap,
        title: "Build First Strategy",
        description:
          "Use the visual flow editor to compose a simple DCA strategy. Deploy and monitor real-time execution.",
      },
      {
        icon: Shield,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Test strategies against historical data, optimize parameters, and validate performance assumptions.",
      },
      {
        icon: Shield,
        title: "Risk Parameters",
        description:
          "Configure position sizing, stop losses, drawdown limits, and portfolio-level risk management rules.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        description:
          "Implement flashbots integration, private transaction routing, and sandwich attack mitigation strategies.",
      },
      {
        icon: Code,
        title: "Multi-Strategy Portfolios",
        description:
          "Compose multiple strategies with dynamic capital allocation, correlation analysis, and rebalancing logic.",
      },
      {
        icon: Shield,
        title: "Enterprise Deployment",
        description:
          "White-label marketplace setup, dedicated SLAs, encrypted execution environments, and institutional custody.",
      },
      {
        icon: BookOpen,
        title: "Monetization Models",
        description:
          "Configure subscription tiers, performance-based fees, and creator economy revenue sharing mechanisms.",
      },
    ],
  },
]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {learningPaths.map((path, i) => (
              <div key={i} className="bg-black border border-gray-900 hover:border-[#ccff00]/50 transition-all">
                <div className="p-8 cursor-pointer" onClick={() => togglePath(i)}>
                  <div className="text-[10px] text-[#ccff00] font-mono uppercase tracking-widest mb-4">
                    {path.level}
                  </div>
                        ...
                        return (
                          <div key={stepIndex} className="relative flex gap-4 pb-8 last:pb-0">
                            ...
                            <div className="flex-1 pt-1">
                              <h4 className="text-[#ccff00] font-bold text-sm uppercase tracking-wide mb-2">
                                {step.title}
                              </h4>
