                      ...
                      {path.steps.map((step, stepIndex) => {
                        ...
                        return (
                          <div key={stepIndex} className='relative flex gap-4 pb-8 last:pb-0'>
                            {!isLast && <div className='absolute left-5 top-10 bottom-0 w-0.5 bg-linear-to-b from-[#ccff00] to-gray-800' />}

                            <div className='relative z-10 shrink-0 w-10 h-10 rounded-full border-2 border-[#ccff00] bg-black flex items-center justify-center'>
