  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-20">
        <Link
          href="/learn"
          className="inline-flex items-center gap-2 text-sm text-gray-400 hover:text-[#ccff00] mb-8 transition-colors"
        >
          ← Back to Learn
        </Link>
        ...
        <p className="text-gray-400 text-lg mb-12">
          Complete REST API documentation for integrating Stratos into your applications.
        </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-gray-950 border border-gray-800 p-4 rounded font-mono text-sm text-gray-300 mb-3">
                  <code>{`curl -X GET https://api.stratos.markets/v1/strategies \\
      ...
      "performance": {
        ...
        "sharpeRatio": 1.8
              ...
              <div>
                ...
                <div className="bg-gray-950 border border-gray-800 p-4 rounded font-mono text-sm text-gray-300">
                  <code>{`curl -X POST https://api.stratos.markets/v1/strategies/deploy \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -d '{"strategyId": "strat_abc123", "capital": 1000}'`}</code>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black border border-gray-900 p-8">
            ...
            <p className="text-gray-400">
              API requests are limited to 100 requests per minute. Exceeding this limit will result in a 429 status
              code.
            </p>
          </div>
        </div>
