        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              Effective risk management separates successful traders from those who blow up their portfolios. Learn how
              to implement robust risk controls in your Stratos strategies.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">Position Sizing</h2>
            <p className="text-gray-400 leading-relaxed mb-6">
              Never risk more than 1-2% of your portfolio on a single trade. Use Stratos's dynamic position sizing nodes
              to automatically calculate appropriate trade sizes based on your risk tolerance and current portfolio
              value.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">Stop Losses and Take Profits</h2>
            <p className="text-gray-400 leading-relaxed mb-6">
              Implement automated stop losses to limit downside exposure. Set take profit targets to lock in gains and
              remove emotional decision-making from the equation. Use trailing stops for trending markets.
            </p>
