    ...
    <div className='min-h-screen bg-black text-white'>
      ...
      <article className='pt-32 pb-20 px-6 md:px-12'>
        <div className='max-w-4xl mx-auto'>
          ...
          <h1 className="text-4xl md:text-6xl font-bold font-['Orbitron'] mb-6">Building Your First Arbitrage Strategy</h1>
          ...
          <div className='prose prose-invert prose-lg max-w-none'>
            <p className='text-gray-400 text-lg leading-relaxed mb-6'>
              Arbitrage opportunities exist when the same asset trades at different prices across venues. Learn how to identify and execute
              profitable arbitrage strategies using Stratos's multi-venue execution engine.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">Types of Arbitrage</h2>
            <p className='text-gray-400 leading-relaxed mb-6'>
              Cross-exchange arbitrage exploits price differences between centralized and decentralized exchanges. Triangular arbitrage
              identifies pricing inefficiencies across three or more trading pairs. Flash loan arbitrage uses borrowed capital to capture
              opportunities without upfront investment.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">Building the Strategy</h2>
            <p className='text-gray-400 leading-relaxed mb-6'>
              Start by monitoring price feeds from multiple sources. Implement logic to calculate profitability after accounting for gas
              costs, slippage, and exchange fees. Use Stratos's flow editor to compose conditional execution paths that trigger only when
              thresholds are met.
            </p>
            ...
            <div className='bg-[#ccff00]/5 border border-[#ccff00]/30 p-6 mt-12'>
              ...
              <p className='text-gray-400 text-sm'>
                Combine arbitrage logic with MEV protection using Flashbots integration. This ensures your transactions execute privately
                without exposing strategy details to competitors.
              </p>
            </div>
          </div>
        </div>
