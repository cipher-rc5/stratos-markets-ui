        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              Liquidity pools are the backbone of decentralized finance, enabling automated market making without
              traditional order books. Understanding how they work is essential for building effective DeFi strategies.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">What Are Liquidity Pools?</h2>
            <p className="text-gray-400 leading-relaxed mb-6">
              A liquidity pool is a smart contract that holds reserves of two or more tokens. These pools facilitate
              decentralized trading by automatically determining exchange rates based on the ratio of tokens in the
              pool, following the constant product formula: x * y = k.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">How They Work</h2>
            <p className="text-gray-400 leading-relaxed mb-6">
              When traders want to swap tokens, they interact with the liquidity pool smart contract. The contract
              calculates the exchange rate based on the current pool reserves and executes the trade, adjusting the pool
              balance accordingly. Liquidity providers earn fees from these trades proportional to their share of the
              pool.
            </p>
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              When building trading strategies on Stratos, consider liquidity depth, trading volume, and fee tiers.
              Monitor pool health metrics and adjust position sizes to minimize slippage while maximizing execution
              efficiency.
            </p>
            ...
            <div className="bg-[#ccff00]/5 border border-[#ccff00]/30 p-6 mt-12">
              ...
              <p className="text-gray-400 text-sm">
                Ready to build your first liquidity-aware strategy? Check out our strategy templates or start composing
                in the visual flow editor.
              </p>
              <Link
                href="/create"
                className="inline-block mt-4 text-[#ccff00] hover:text-white transition-colors text-sm font-bold"
              >
