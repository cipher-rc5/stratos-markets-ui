        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='prose prose-invert prose-lg max-w-none'>
            <p className='text-gray-400 text-lg leading-relaxed mb-6'>
              Maximal Extractable Value (MEV) can significantly impact strategy performance. Learn how to protect your transactions from
              front-running, sandwich attacks, and other MEV exploits.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">Understanding MEV</h2>
            <p className='text-gray-400 leading-relaxed mb-6'>
              MEV refers to profit extracted by reordering, inserting, or censoring transactions within blocks. Sophisticated bots monitor
              the mempool for profitable opportunities, often at the expense of regular users.
            </p>

            <h2 className="text-2xl font-bold font-['Orbitron'] text-white mt-12 mb-4">Protection Mechanisms</h2>
            <p className='text-gray-400 leading-relaxed mb-6'>
              Stratos integrates Flashbots Protect for private transaction submission. Your transactions bypass the public mempool entirely,
              preventing front-running and sandwich attacks while maintaining execution guarantees.
            </p>
