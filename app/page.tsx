...
import { type Strategy, useStrategies } from '@/lib/hooks/use-strategies';
...
export default function StratosPage() {
  ...
  const { strategies, loading, error } = useStrategies({ category: categoryFilter || undefined });
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
            ...
            <div className='lg:col-span-8'>
              ...
              <h1
                ...
                TRADE <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#ccff00] to-transparent'>DEFI LOGIC</span>
                <br />
                AS DATA STREAMS
              </h1>
      ...
      <section className='relative py-20 px-6 bg-black/30'>
        <div className='max-w-[1920px] mx-auto'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
            {loading ?
              <div className='col-span-full text-center py-12 text-gray-500'>Loading strategies...</div> :
              error ?
              <div className='col-span-full text-center py-12 text-red-500'>Error: {error}</div> :
              strategies.length === 0 ?
              <div className='col-span-full text-center py-12 text-gray-500'>No strategies found</div> :
