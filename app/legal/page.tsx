            ...
            <div className='space-y-8 text-gray-400 leading-relaxed'>
              ...
              <section>
                ...
                <p>
                  ...
                  use the materials for any commercial purpose, or attempt to decompile or reverse engineer any software contained on the
                  platform.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  your account, and for ensuring that all uses of your account comply fully with the provisions of these Terms of Service.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  In no event shall Stratos or its suppliers be liable for any damages arising out of the use or inability to use the
                  materials on the platform, even if Stratos or an authorized representative has been notified of the possibility of such
                  damage.
                </p>
              </section>
            </div>
            ...
            <div className='space-y-8 text-gray-400 leading-relaxed'>
              <section>
                ...
                <p>
                  ...
                  participate in interactive features, or communicate with us. This may include wallet addresses, transaction data, and
                  usage information.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  with service providers who perform services on our behalf, in response to legal requests, or to protect rights and safety.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  If you are a resident of the European Economic Area (EEA), you have certain data protection rights under the General Data
                  Protection Regulation (GDPR):
                </p>
                <ul className='list-disc list-inside mt-4 space-y-2 ml-4'>
                  <li>
                    <strong className='text-white'>Right to Access:</strong> You can request access to your personal data
                  </li>
                  <li>
                    <strong className='text-white'>Right to Rectification:</strong> You can request correction of inaccurate data
                  </li>
                  <li>
                    <strong className='text-white'>Right to Erasure:</strong> You can request deletion of your personal data
                  </li>
                  <li>
                    <strong className='text-white'>Right to Restrict Processing:</strong> You can request limitation of data processing
                  </li>
                  <li>
                    <strong className='text-white'>Right to Data Portability:</strong> You can request transfer of your data
                  </li>
                  <li>
                    <strong className='text-white'>Right to Object:</strong> You can object to processing of your personal data
                  </li>
                  <li>
                    <strong className='text-white'>Right to Withdraw Consent:</strong> You can withdraw consent at any time
                  </li>
                </ul>
                <p className='mt-4'>
                  To exercise these rights, please contact us at privacy@stratos.markets. We will respond to your request within 30 days.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  appropriate safeguards are in place for such transfers in compliance with GDPR requirements.
                </p>
              </section>
            </div>
          </TabsContent>
          ...
          <TabsContent value='cookies'>
            ...
            <div className='space-y-8 text-gray-400 leading-relaxed'>
              ...
              <section>
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <p>
                      These cookies are necessary for the platform to function and cannot be disabled. They include session management,
                      security features, and wallet connectivity.
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      ...
                      experience. You can opt-out of these cookies.
                    </p>
                  </div>
                  <div>
              ...
              <section>
                ...
                <p>
                  You can control and manage cookies through your browser settings or using our cookie consent banner. You can also manage
                  your preferences at any time by clicking "Cookie Preferences" in the footer.
                </p>
                <p className='mt-4'>
                  Please note that disabling certain cookies may affect the functionality of the platform and your ability to use certain
                  features.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We may use third-party service providers who also set cookies on your device to provide their services (such as
                  analytics). These providers have their own privacy policies governing the use of cookies.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We may update this Cookie Policy from time to time. We will notify you of any changes by posting the new policy on this
