      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-20">
        ...
        <div className="space-y-8 text-gray-400 leading-relaxed">
          ...
          <section>
            ...
            <p>
              <strong className="text-white">Essential Cookies:</strong> These cookies are necessary for the platform to
              function and cannot be disabled. They include session management and security features.
            </p>
            <p className="mt-4">
              <strong className="text-white">Analytics Cookies:</strong> These cookies help us understand how users
              interact with the platform, allowing us to improve functionality and user experience.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              affect the functionality of the platform and your ability to use certain features.
            </p>
          </section>
