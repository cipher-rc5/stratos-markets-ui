...
export default function SecurityPage() {
  return (
    <div className='min-h-screen bg-black text-white'>
        ...
        <div className='max-w-[1400px] mx-auto'>
          <div className='max-w-3xl'>
            ...
            <p className='text-gray-400 text-lg leading-relaxed'>
              Your assets and data are protected by institutional-grade security measures. Learn about our approach to keeping your
              strategies and funds safe.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='max-w-[1400px] mx-auto'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            {[{
              ...
              description: 'All strategy contracts undergo rigorous third-party security audits before deployment to the marketplace.'
            }, {
              icon: Lock,
              title: 'Non-Custodial Architecture',
              description: 'You maintain complete control of your assets. Stratos never has access to your private keys or funds.'
            }, {
              icon: Eye,
              title: 'Real-Time Monitoring',
              description: 'Continuous monitoring of all deployed strategies with automatic circuit breakers for anomalous behavior.'
            }, {
              icon: AlertTriangle,
              title: 'Bug Bounty Program',
              description: 'We reward security researchers who responsibly disclose vulnerabilities through our bug bounty program.'
            }].map((feature, i) => (
        ...
        <div className='max-w-[1400px] mx-auto'>
          ...
          <div className='space-y-6'>
            {[
              ...
              { title: 'Access Controls', description: 'Multi-signature requirements for critical platform operations and upgrades.' },
              { title: 'Incident Response', description: '24/7 security operations center with automated incident detection and response.' }
            ].map((practice, i) => (
      ...
      {/* Contact */}
      <section className='py-20 px-6 md:px-12 bg-linear-to-b from-gray-950 to-black'>
        <div className='max-w-[1400px] mx-auto text-center'>
          <h2 className="text-3xl font-bold font-['Orbitron'] mb-6">Report a Security Issue</h2>
          <p className='text-gray-400 mb-8 max-w-2xl mx-auto'>
            If you discover a security vulnerability, please report it to security@stratos.io. We appreciate responsible disclosure and will
