  ...
  for (let i = days; i >= 0; i--) {
    ...
    data.push({
      ...
      assets: {
        ETH: {
          amount: 5.2345,
          value: totalValueUSD * 0.45,
          price: (totalValueUSD * 0.45) / 5.2345,
        },
        BTC: {
          amount: 0.1234,
          value: totalValueUSD * 0.21,
          price: (totalValueUSD * 0.21) / 0.1234,
        },
        USDC: {
          amount: 5000,
          value: 5000,
        ...
        LINK: {
          amount: 150,
          value: totalValueUSD * 0.12,
          price: (totalValueUSD * 0.12) / 150,
        },
      },
    })
  }
