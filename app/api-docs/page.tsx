        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Build on Stratos with our comprehensive REST and WebSocket APIs. Deploy strategies, monitor performance,
      ...
      <section className="py-20 px-6 md:px-12 bg-gradient-to-b from-black to-gray-950">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="bg-gray-950 border border-gray-900 p-8 font-mono text-sm">
            ...
            <div className="text-[#ccff00]">import</div> {"{"} StratosClient {"}"}{" "}
            <div className="text-[#ccff00] inline">from</div>{" "}
            <div className="text-green-400 inline">'@stratos/sdk'</div>
            <br />
            <br />
            <div className="text-[#ccff00]">const</div> client = <div className="text-[#ccff00] inline">new</div>{" "}
            StratosClient({"{"}
            <br />
            {"  "}apiKey: process.env.STRATOS_API_KEY
            <br />
            {"}"})
          </div>
        </div>
