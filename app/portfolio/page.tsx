...
import { TrendingUp, DollarSign, Activity, BarChart3, PieChart } from "lucide-react"
      ...
      <div className="max-w-[1920px] mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-black border border-gray-900 p-6 hover:border-[#ccff00]/30 transition-all">
            ...
            <div className="text-3xl font-bold text-[#ccff00] mb-2">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-900 bg-gray-950">
                  ...
                  <th className="text-right p-4 text-xs text-gray-600 uppercase tracking-wider font-bold">
                    Entry Price
                  </th>
                  <th className="text-right p-4 text-xs text-gray-600 uppercase tracking-wider font-bold">
                    Current Price
