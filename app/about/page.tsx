        ...
        <div className='max-w-[1400px] mx-auto'>
          <div className='max-w-3xl'>
            ...
            <p className='text-gray-400 text-lg leading-relaxed'>
              Stratos defines the intersection of high-stakes strategy and digital ownership. We're building the future of autonomous
              trading, where institutional-grade tools meet decentralized accessibility.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='max-w-[1400px] mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            {[{
              ...
              description: 'Make institutional-quality trading strategies accessible to everyone through verified, executable logic.'
            }, {
              title: 'Empower Creators',
              description: 'Enable strategy developers to monetize their expertise and build sustainable businesses on-chain.'
            }, {
              title: 'Secure Innovation',
              description: 'Provide the infrastructure for safe, audited, and transparent strategy execution at scale.'
            }].map((item, i) => (
