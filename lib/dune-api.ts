...
const getMockBalances = (): DuneBalance[] => [
  {
    chain: "ethereum",
    chain_id: 1,
...
const getMockTransactions = (): DuneTransaction[] => [
  {
    chain: "ethereum",
    chain_id: 1,
    ...
    decoded: {
      ...
      parameters: { recipient: "0x...", amount: "1000000000000000000" },
    },
  },
]

const getMockDefiPositions = (): DuneDefiPosition[] => [
  {
    type: "CompoundV2",
    chain_id: 1,
    protocol: "Aave V3",
